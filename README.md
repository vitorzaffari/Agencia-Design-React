...
<br><br>
A função responsável pela funcionalidade foi criada no arquivo <em>'App.js'</em> e conecta todos os elementos através de <em>props</em>.
<br><br>
